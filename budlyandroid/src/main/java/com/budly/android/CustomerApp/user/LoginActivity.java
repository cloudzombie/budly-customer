...
import com.budly.android.CustomerApp.PasswordResetActivity;
import com.budly.R;
...
public class LoginActivity extends BaseActivity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        link_reset.setOnClickListener(this);
	}
			...
			public void onSuccess(HttpResponse httpResponse, JSONObject re) {
				...
				try {
					...
					if(status==200) {
                        ...
                        mUser.recomendation = data.getString("recomendation");
                        mUser.expiry = data.getString("expiration");
                        mUser.doc_name = data.getString("doc_name");
                        mUser.doc_web = data.getString("doc_web");
                        mUser.clinic_phone = data.getString("clinic_phone");
						try {
                        ...
                        try {
                            mUser.image_recomendation = data.getString("image_recomendation");
                        } catch (Exception e) {}
