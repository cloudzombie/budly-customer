...
//								startActivity(new Intent(ProfileActivity.this, ProfilePictureLicenseActivity.class));
								startActivity(new Intent(ProfileActivity.this, RecomendationActivity.class));
