...
/**
 * Created by EdwinSL on 2/11/2015.
 */
public class RecomendationActivity extends BaseActivity implements View.OnClickListener {
    Button btn_next;
            ...
            Toast.makeText(this, "You must enter all information", Toast.LENGTH_SHORT).show();
                ...
                HttpBasicClientHelper client = new HttpBasicClientHelper(new MyJsonAsyncCallback(){
                    ...
                    public void onFailure(Exception error) {
                        ...
                        Common.saveException(error);
                        Toast.makeText(RecomendationActivity.this, "Register failed. Please try again", Toast.LENGTH_SHORT).show();
                    }
                    ...
                    public void onSuccess(HttpResponse httpResponse, JSONObject response) {
                        ...
                        try {
                            ...
                            if(is_update && status==200) {
                                ...
                                startActivity(new Intent(RecomendationActivity.this, ProfilePictureRecomendationActivity.class));
                                runOnUiThread(new Runnable() {

                                    @Override
                                    public void run() {
                                        Toast.makeText(RecomendationActivity.this, "Register success", Toast.LENGTH_SHORT).show();
                                    }
                                });
                            ...
                            runOnUiThread(new Runnable() {
                                ...
                                @Override
                                public void run() {
                                    Toast.makeText(RecomendationActivity.this, msg, Toast.LENGTH_SHORT).show();
                                }
                            });
                        } catch (Exception e) {
                            Common.saveException(e);
                            ...
                            runOnUiThread(new Runnable() {
                                ...
                                @Override
                                public void run() {
                                    Toast.makeText(RecomendationActivity.this, "Register failed", Toast.LENGTH_SHORT).show();
                                }
                            });
                        }
...
//                client.register2(mUser.phone_number, mUser.recomendation,mUser.expiry,mUser.clinic_phone,mUser.doc_name,mUser.doc_web);
