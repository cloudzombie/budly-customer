...
import com.budly.android.CustomerApp.driver.OrderCancelledActivity;
...
public class OrderConfirmedActivity extends BaseActivity implements OnClickListener,Progress{
...
//            finish();
        ...
        btn_report = (ImageView) findViewById(R.id.btn_report);
       ...
       g = new Globals();
		...
		try {
            ...
            HttpBasicClientHelper c = new HttpBasicClientHelper(new MyJsonAsyncCallback(){
                @Override
                public void onSuccess(HttpResponse httpResponse, JSONObject re) {
                    ...
                    try {
                        ...
                        if(status==200) {
                            String start_time = re.getString("data");
                            if (start_time.equals("")){
                                return;
                            }

                            progresss(start_time);
                        }
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
...
//		}).start();
    ...
    public void progresss(String start_time){
        g.setProgressTimer(order_id,String.valueOf(order_id),time,start_time,this);
    }
...
//		}
	...
	BroadcastReceiver mReceiver = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {
            ...
            Common.turnOnScreen(OrderConfirmedActivity.this);
