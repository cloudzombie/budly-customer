 ...
 */
public class ProgressButton2 extends CompoundButton {
  ...
  public ProgressButton2(Context context, AttributeSet attrs) {
    this(context, attrs, R.attr.progressButtonStyle);
  }

  public ProgressButton2(Context context, AttributeSet attrs, int defStyle) {
    super(context, attrs, defStyle);
    init(context, attrs, defStyle);
  }

  /**
   * Initialise the {@link ProgressButton2}.
   *
  ...
  private void init(Context context, AttributeSet attrs, int defStyle) {
    ...
    int pinnedDrawable =
        a.getResourceId(R.styleable.ProgressButton_pinnedDrawable,R.drawable.transparent);
    mPinnedDrawable = res.getDrawable(pinnedDrawable);
    mPinnedDrawable.setCallback(this);

    int unpinnedDrawable = a.getResourceId(R.styleable.ProgressButton_unpinnedDrawable, R.drawable.transparent);
    mUnpinnedDrawable = res.getDrawable(unpinnedDrawable);
    mUnpinnedDrawable.setCallback(this);

    int shadowDrawable =
        a.getResourceId(R.styleable.ProgressButton_shadowDrawable, R.drawable.transparent);
    mShadowDrawable = res.getDrawable(shadowDrawable);
    mShadowDrawable.setCallback(this);

    mInnerSize = res.getDimensionPixelSize(R.dimen.progress2_inner_size);
  ...
  /** A {@link android.os.Parcelable} representing the {@link ProgressButton2}'s state. */
